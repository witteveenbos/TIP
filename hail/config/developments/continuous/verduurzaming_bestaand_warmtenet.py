...
class VerduurzamingBestaandWarmtenet(AbstractDevelopment):

    name = "Verduurzaming bestaand warmtenet"
    key = "verduurzaming_bestaand_warmtenet"
    unit = "#"
    ...
    @staticmethod
    def default(var: "Var"):
        return bestaand_warmtenet_default(var)
    ...
    def aggregate(cls, var: "Var"):
        return var.ui.verduurzaming_bestaand_warmtenet | cls.default(var)
