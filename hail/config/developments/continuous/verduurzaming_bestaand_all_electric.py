...
class VerduurzamingBestaandAllElectric(AbstractDevelopment):

    name = "Verduurzaming bestaand all-electric"
    key = "verduurzaming_bestaand_all_electric"
    unit = "#"
    ...
    @staticmethod
    def default(var: "Var"):
        return bestaand_allelectric_default(var)
    ...
    def aggregate(cls, var: "Var"):
        return var.ui.verduurzaming_bestaand_all_electric | cls.default(var)
