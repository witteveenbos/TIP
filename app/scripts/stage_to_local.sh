...
readonly LOCAL_DOMAIN=stripedtodo.nl.test:8081
readonly SSH_HOST=deploy@stage.stripedtodo.nl
...
ssh $SSH_HOST "export PGUSER=postgres && pg_dump pmiek_stripes --no-owner > /tmp/db-dump.sql"
